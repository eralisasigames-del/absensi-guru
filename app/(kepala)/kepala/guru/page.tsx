...
export default function KelolaGuruPage() {
  ...
  async function loadTeachers() {
    ...
    // Guru yang tanggal join-nya sudah tiba otomatis menjadi aktif, kecuali sudah resign.
  ...
  async function addTeacher(event: FormEvent) {
    ...
    try {
      ...
      setMessage(`Guru ${form.nama} berhasil ditambahkan. Password awal: ${result.temporaryPassword}`); setForm({ nama: "", email: "", tanggal_join: todayWib() }); setShowForm(false); await loadTeachers();
